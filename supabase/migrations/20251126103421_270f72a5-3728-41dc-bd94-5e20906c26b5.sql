-- Fix the handle_new_user function to handle duplicate signups gracefully
...
BEGIN
  ...
  -- Insert profile with auto-assigned role (handle duplicates)
  ...
  -- Automatically unlock the welcome achievement (handle duplicates)
